...
public abstract class Command {
     ...
     * @param invocationStatus режим, с которым следует исполнить команду.
     ...
     */
    public abstract void execute(String[] arguments, InvocationStatus invocationStatus, PrintStream printStream)
